#!/usr/bin/env python3
"""
Create Student (Voter) User Script
==================================
Creates a new student/voter user with auto-generated credentials.

Usage: python scripts/create_student.py
...
def generate_user_id(prefix='C225'):
    """Generate a unique student ID (TU Dublin format)."""
...
def create_student():
    """Create a new student user with generated credentials."""
